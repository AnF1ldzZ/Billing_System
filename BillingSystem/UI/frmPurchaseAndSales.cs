...
namespace BillingSystem.UI
{
    public partial class frmPurchaseAndSales : Form
    {
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            //Now transter or set the value form DeCustBLL to textboxes
        ...
        {
            //Check ift the grandTotal has value or not if it has not value then calculate the discount first
        ...
        private void txtPaidAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            //Display th return amount as well
            txtReturnAmount.Text = returnAmount.ToString();
        }

        private void btnSave_Click(object sender, EventArgs e)
        {
            //Get the Valuese From PurchaseSales Form First
            ...
            //Lets Create a Boolean Varible and set its value to false 
            bool success = false;
            ...
            using(TransactionScope scope = new TransactionScope())
            {
                ...
                for(int i=0;i<transactionDT.Rows.Count;i++)
                {
                    ...
                    //Lets check wheter we are on Purchase or sales
                    bool x=true;
                    ...
                    bool y = tdDAL.InsertTransationDetail(transactionDetail);
                    success = w && x && y;
                }
                ...
                if (success == true)
                {
                    ...
                    printer.Title = "\r\n\r\n\r\n ANFILDSTORE \r\n\r\n";
                    printer.SubTitle = "Nathakamon Trirungkit \r\n Phone:0895479446";
                    ...
                    //Clear the ADta Grid View and Clear All the Textboxes
