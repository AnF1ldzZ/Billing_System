    ...
    public class productsDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                //Creating SQL Commend to Execute Query
        ...
        {
            //Creating Boolean Varible and set its default value to false
            ...
            try
            {
                ...
                //Creating SQL Command tp pass the values
                SqlCommand cmd = new SqlCommand(sql, conn);
                ...
                //If the Query is executed sucessfully then the value of rows will be greater than 0 else it will be less than 0
                if (rows > 0)
                {
        ...
        {
            //Create a boolen varible and set its initial value to false
            bool isSuccess = false;
            ...
            try
            {
                //SQL Query to Update Dat inDatabase
        ...
        public bool Dalete(productsBLL p)
        {
            ...
            try
            {
                ...
                int rows = cmd.ExecuteNonQuery();
                //If the Query is executed successfully then the value of rows will be greated than 0 else it will be less than 0
                if (rows > 0)
                {
        ...
        {
            //SQL Connection fo DB Connection
            SqlConnection conn = new SqlConnection(myconnstrng);
            //Creating DAtaTable to hold valure from Database
            DataTable dt = new DataTable();
        ...
        #endregion
        #region METHOD TOGET CURRENT QUANTITY FROM  THE DATABASE BASED ON PRODUCT ID
        public decimal GetProductQty(int ProductID)
        {
            //SQL Connection First
            SqlConnection conn = new SqlConnection(myconnstrng);
            //Create a Decimal Varible and Set its default value to 0
            decimal qty = 0;

            //Create Data Table to save the data from database temporarity
            DataTable dt = new DataTable();
        ...
        public bool UpdateQuantity(int ProductID, decimal Qty)
        {
            ...
            try
            {
                ...
                //Create SQL Command to Pass the  value in to Query
                SqlCommand cmd = new SqlCommand(sql, conn);
                ...
                //Lets check if the query executed Successfully or not 
                if(rows>0)
                {
                    //Query Executed Successfully
                    success=true;
        ...
        public bool IncreaseProduct(int ProductID, decimal IncreaseQty)
        {
            ...
            try
            {
                ...
                //Increase the current Quatity by the qty purchased from Dealer
                decimal NewQty = currentQty + IncreaseQty;

                //Update the Prodcty Quatity Now
        ...
        {
            //Create Boolean Varible and Set its Value to false
            bool success= false;
